...
<body>
    ...
    <div class="loginContainer">
        ...
        <div class="formContainer m-3">
            ...
            <form class="formBox" id="loginFormValidation" action="loginPage.php" method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="exampleInputPassword1" name="usrpassword" require>
                </div>
