    ...
    <div class="updateContainer p-3 m-0 border-0 bd-example m-0 border-0">
        <div class="profileContainer">
            ...
            <?php if ($stmt) {
                ...
                <a class="goback" href="mainPage.php" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
        ...
        <div class="formContainer">
            ...
            <form class="row g-3 mt-3" method="POST" action="updatePage.php">
                <div class="col-md-6">
