...
<body>
    ...
    <div class="signUpContainer p-3 m-0 border-0 bd-example m-0 border-0">
        ...
        <div class="formContainer">
            ...
            <form class="row g-3" id="signupFormValidation" method="POST" action="signupPage.php">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="password" class="form-control" name="usrpassword" id="validationServerPassword"
                        required>
                </div>
                <div class="col-md-6">
